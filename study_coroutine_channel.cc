...
ZEND_BEGIN_ARG_INFO_EX(arginfo_study_coro_channel_construct,
                       0, 0, 0)
...
static const zend_function_entry study_coro_channel_methods[] =
        {
                PHP_ME(study_coro_channel, __construct, arginfo_study_coro_channel_construct, ZEND_ACC_PUBLIC |
...
void study_coro_channel_init() {
    ...
    study_coro_channel_ce_ptr = zend_register_internal_class(&study_coro_channel_ce
